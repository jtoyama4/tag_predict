...
if __name__ == '__main__':
    ...
    gru = gru4rec.GRU4Rec(tree=tree, tagdic=tagdic, tag_to_idx=_tagdic, print_freq=100, n_epochs=20, layers=[n_hidden], loss='cross-entropy', batch_size=50, dropout_p_hidden=0.2, learning_rate=1.0, momentum=0.0,final_act='linear')
